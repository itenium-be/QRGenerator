export const Wordmark = () => (
  <svg className="mark" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <rect x="14" y="14" width="3.5" height="3.5" fill="var(--accent)" />
    <rect x="19.5" y="19.5" width="3.5" height="3.5" fill="var(--accent)" />
    <rect x="19.5" y="14" width="3.5" height="3.5" fill="currentColor" opacity=".35" />
  </svg>
)
